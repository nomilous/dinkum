...
var extend, parallel, promised, queue, requestor, sequence, transport, _ref;
        ...
        return parallel((function() {
          ...
          for (_i = 0, _len = requests.length; _i < _len; _i++) {
            ...
            _results.push((function(request) {
              var promise;
              opts = request.opts, promise = request.promise;
              return function() {
                return requestor.transport.request(opts, promise);
              };
            })(request));
          }
          return _results;
