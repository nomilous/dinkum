...
var HttpRequest, count, extend, parallel, promised, queue, requestor, sequence, transport, _ref;
...
exports.requestor = extend(queue, function(superclass, config) {
  ...
  requestor = {
    ...
    request: promised(function(action, opts, deferral) {
      var notify, reject, resolve;
      resolve = action.resolve, reject = action.reject, notify = action.notify;
      return sequence([
        function() {
          return superclass.enqueue(new HttpRequest(deferral, opts));
        }, function() {
        ...
        return parallel((function() {
          ...
          for (_i = 0, _len = requests.length; _i < _len; _i++) {
            ...
            _results.push((function(request) {
              return function() {
                return requestor.transport.request(request);
              };
            })(request));
          }
          return _results;
